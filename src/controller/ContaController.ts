...
export class ContaController implements ContaRepository{
    ...
    // CRUD da Conta - procurarPorNumero, listarTodas, cadastrar, atualizar, deletar
    ...
    // Métodos Bancários - sacar, depositar, transferir
        ...
        if (contaOrigem !== null && contaDestino !== null) {
            if(contaOrigem.sacar(valor) == true){
                ...
                console.log(colors.fg.green,"\nA Transferência da Conta numero: " + numeroOrigem +
                    " para a Conta numero: " + numeroDestino + " foi efetuado com sucesso!", colors.reset);
            }
        }else
